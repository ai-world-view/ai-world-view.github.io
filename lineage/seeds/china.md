...
- **README knowledge table**: 75 rows.
- **Dedicated topic files**: 75.
  ...
  - `people/mencius.md` — Mencius
  - `people/qin-shi-huang.md` — Qin Shi Huang
  - `people/sima-qian.md` — Sima Qian
  ...
  - `people/zhuangzi.md` — Zhuangzi
- **Categories with content**: Culture & Society (12), Economy (6), Geography (9),
  Government & Politics (11), History (20), People (17).
...
- **Timeline**: `TIMELINE.md` — present (China is time-oriented); 318 dated milestones.
- **Master index / TOC**: `INDEX.md` — present; groups all content by taxonomy category.
- **Cross-references**: `## Related` blocks present in all 75 dedicated topic files.
...
### G1-T25 — 2026-09-09 — Tick 25: The classical mind — Mencius, Sima Qian, and Zhuangzi

Added three topics deepening the People category and reconstructing the intellectual world of early China from the Warring States philosophers to the Han founder of Chinese historiography: `people/mencius.md` (Mengzi, c. 372–289 BCE — the Confucian "Second Sage," the doctrine of innate human goodness and the four moral sprouts, the child-at-the-well and Ox Mountain parables, humane government (*renzheng*) and the well-field system, the theory of conditional legitimacy and righteous revolution, the debate with Xunzi, and the *Mencius*'s canonization among the Four Books through Zhu Xi and Wang Yangming), `people/sima-qian.md` (c. 145–86 BCE — the Grand Historian, the composition and 130-chapter architecture of the *Records of the Grand Historian* (*Shiji*), the *liezhuan* biographical method, the Li Ling affair and his castration, the letter to Ren An on transmuting suffering into achievement, and the *Shiji*'s founding of two millennia of imperial historiography), and `people/zhuangzi.md` (Zhuang Zhou, c. 369–286 BCE — the foundational Daoist philosopher after Laozi, *wu wei* and *ziran*, perspectivism and the relativity of values, the Cook Ding, Roc-and-cicada, and Butterfly Dream parables, the friendship with Huizi, Guo Xiang's editing and the Wei-Jin *xuanxue* revival, and the text's influence on Chan Buddhism and Chinese aesthetics), each with `title`/`preview`/`date`/`category` front matter (single ISO dates), Summary, thematic sections, a `crossrefs`-wrapped Related block, and Sources. People now holds seventeen topics; all six categories remain populated. Polished the new prose for encyclopedic neutral tone and corrected several factual errors: in Sima Qian, corrected the punishment from "*lingchi*" (death by slicing) to *gongxing*, the palace punishment of castration, and relocated the *Kongzi shijia* biography of Confucius from the "Basic Annals" to the Hereditary Houses section (Chapter 47), and removed a dubious historiographical term (*fayue*); reconciled Zhuangzi's birthplace of Meng from "the state of Chu" to the town of Meng in the state of Song across both the Zhuangzi and Sima Qian articles; harmonized Huizi's dates to c. 370–310 BCE where the Zhuangzi article had given two conflicting ranges (c. 350–260 and c. 380–305 BCE), and corrected the ninety-thousand-*li* conversion to roughly 45,000 km; and in Mencius, repaired a malformed subheading and pruned a Related link to a non-existent Xunzi article. Fixed cross-references: removed a broken placeholder anchor (`#`) and relabeled a mislabeled "Chinese Painting and Aesthetics" link to Calligraphy in Zhuangzi. Verified every cross-reference resolves (0 broken links repo-wide). Refreshed the structural layer: appended Mencius, Sima Qian, and Zhuangzi to the People index and INDEX; the README knowledge table already carried the three new rows (75 total); extended `TIMELINE.md` from 311 to 318 dated milestones (Mencius's birth c. 372 BCE and death c. 289 BCE; Zhuangzi's birth c. 369 BCE and death c. 286 BCE; and Sima Qian's birth c. 145 BCE, his c. 99 BCE condemnation over Li Ling, and his c. 86 BCE death upon completing the *Shiji*); and wove eleven reciprocal cross-references from existing articles (Confucius to all three; Confucianism, the Mandate of Heaven, Mohism, the Imperial Examination System, and the Song Dynasty to Mencius; Taoism and the Warring States Period to Zhuangzi; and the Han Dynasty, the Qin Dynasty, the Imperial Examination System, and Lu Xun to Sima Qian). Regenerated seed sections 4–5 to match live state (75 topic files, 75 README rows, 318 milestones, no empty categories).
